    ...
    <body>
        <article class="page-container">
            <form class="form form-horizontal" id="form-article-add">
                <input type="hidden" id="indeximg_position" name="indeximg_position" value="<?php echo ($arrData['indeximg']); ?>">
                <input type="hidden" id="thumbimg_position" name="thumbimg_position" value="<?php echo ($arrData['thumbimg']); ?>">
                <input type="hidden" id="content" name="content">
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">* </span>文章标题：</label>
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" placeholder="" id="title" name="title" value="<?php echo ($arrData['title']); ?>">
                    </div>
                </div>
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <span class="select-box">
                            <select class="select" size="1" id="acid" name="acid">
                                ...
                                <?php if(is_array($arrCategories)): foreach($arrCategories as $k=>$vo): if($vo['acid'] == $arrData['acid']): ?><option value="<?php echo ($vo["acid"]); ?>" selected><?php echo ($vo["category"]); ?></option>
                                        <?php else: ?>
                                        <option value="<?php echo ($vo["acid"]); ?>"><?php echo ($vo["category"]); ?></option><?php endif; endforeach; endif; ?>
                            </select>
                        </span>
                    </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" placeholder="" id="from" name="from" value="<?php echo ($arrData['from']); ?>">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">* </span>阅读次数：</label>
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" placeholder="" id="read_times" name="read_times" value="<?php echo ($arrData['read_times']); ?>">
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        ...
                        <p><br><img src="/Upload/<?php echo ($arrData['indeximg']); ?>" id="indeximg_see" style="width: 341px;height: 440px;"></p>
                    </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        ...
                        <p><br><img src="/Upload/<?php echo ($arrData['thumbimg']); ?>" id="thumbimg_see" style="width: 244px;height: 182px;"></p>
                    </div>
                </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <script id="editor" type="text/plain" style="width:800px;height:800px;">
        ...
        <script type="text/javascript">
            ...
            $('#btn_submit').on('click', function () {
                ...
                $.post('/index.php/Admin/Article/editArticle?arid=<?php echo ($arrData["arid"]); ?>', data, function (ret) {
                    if (ret == 'true') {
