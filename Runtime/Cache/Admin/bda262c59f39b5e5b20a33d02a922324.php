...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a class="btn btn-primary radius" data-title="添加图片" href="javascript:;"
                                                               onclick="member_add('添加图片', '/index.php/Admin/Setup/addBanner', '780', '600')"><i class="Hui-iconfont">
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <?php if(is_array($arrData)): foreach($arrData as $k=>$vo): ?><tr class="text-c">
                ...
                <td>
                    <a title="预览" href="javascript:;" onclick="pic_see('图片预览', '/index.php/Admin/Setup/viewPic?img=<?php echo ($vo["img"]); ?>', '4', '780', '550')" class="ml-5" style="text-decoration:none"><i
...
<script type="text/javascript">
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post('/index.php/Admin/Api/delete?datasheet=banner&column=baid&id='+id, function (ret) {
                if (ret == 'true') {
    ...
    function member_stop(obj, id ,status) {
        layer.confirm('确认要下架吗？', function (index) {
            ...
            $.post('/index.php/Admin/Api/startOrStop?datasheet=banner&column=baid&id='+id+'&status='+status , function (ret) {
                if (ret == 'true') {
