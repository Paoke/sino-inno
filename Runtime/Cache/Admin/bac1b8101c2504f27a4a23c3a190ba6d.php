            ...
            <form action="" method="post" class="form form-horizontal" id="form-edit-word">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" value="<?php echo ($arrData[0]["value"]); ?>" placeholder="请输入标题" id="title" name="title">
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" value="<?php echo ($arrData[3]["value"]); ?>" placeholder="请输入费用" id="expense" name="expense">
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" value="<?php echo ($arrData[3]["value"]); ?>" placeholder="请输入报名链接" id="link" name="link">
                    </div>
                </div>
