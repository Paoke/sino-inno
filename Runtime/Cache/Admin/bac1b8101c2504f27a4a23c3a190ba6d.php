            ...
            <form class="form form-horizontal" id="form-activity-add">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" placeholder="请输入标题" id="title" name="title">
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" placeholder="请输入费用" id="expense" name="expense">
                    </div>
                </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-5">
                        <input type="text" class="input-text" placeholder="请输入报名链接" id="link" name="link">
                    </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        ...
                        <p><br><img src="" id="indeximg_see" style="width: 700px;height: 366px;"></p>
                    </div>
                </div>
                <div class="row cl">
                    <div class="col-xs-2 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                        <input class="btn btn-primary radius" type="button" id="btn_submit" value="&nbsp;&nbsp;添加&nbsp;&nbsp;">
                    </div>
                </div>
            </form>
        </article>
