...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 关于我们 <span
        class="c-gray en">&gt;</span> 概况列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
                                              href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">
    &#xe68f;</i></a></nav>
<div class="page-container">
    
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a class="btn btn-primary radius" data-title="添加概述" href="javascript:;"
                                                          onclick="article_add('添加概述','/index.php/Admin/About/addSummary')"><i class="Hui-iconfont">
        &#xe600;</i> 添加概述</a></span> <span class="r">共有数据：<strong><?php echo ($size); ?></strong> 条</span></div>
    <div class="mt-20">
            ...
            <?php if(is_array($arrData)): foreach($arrData as $k=>$vo): ?><tr class="text-c">
                ...
                <td class="f-14 td-manage">
                    ...
                    <a style="text-decoration:none" class="ml-5" 
                       onClick="article_edit('编辑','/index.php/Admin/About/editSummary?id=<?php echo ($vo["id"]); ?>','<?php echo ($vo["id"]); ?>')"  href="javascript:;" title="编辑">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a> 
                    <a style="text-decoration:none" class="ml-5"
                       onClick="article_del(this,'<?php echo ($vo["id"]); ?>')" href="javascript:;" title="删除">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                </td>
...
<script type="text/javascript">
    ...
    function article_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.post('/index.php/Admin/Api/delete?datasheet=config&column=id&id='+id, function (ret) {
                if (ret == 'true') {
