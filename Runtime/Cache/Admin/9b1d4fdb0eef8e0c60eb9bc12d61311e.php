            ...
            <form action="" method="post" class="form form-horizontal" id="form-category-add">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="<?php echo ($arrData[0]["value"]); ?>" placeholder="请输入分类名称" id="category" name="category">
                    </div>
                </div>
                ...
                <div class="row cl">
                    <div class="col-xs-2 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                        <input class="btn btn-primary radius" type="submit" id="btn_submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
                    </div>
                </div>
            </form>
        </article>
            ...
            $(function () {
                $("#form-category-add").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        var data = {};
                        var t = $('#form-category-add').serializeArray();
                        $.each(t, function() {
                            data[this.name] = this.value;
                        });
                        $.post('/index.php/Admin/Article/add?action=article_category', data, function (ret) {
                            if (ret == 'true') {
