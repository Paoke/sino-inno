...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a class="btn btn-primary radius" data-title="添加活动" href="javascript:;"
                                                          onclick="article_add('添加活动','/index.php/Admin/Activity/addActivity')"><i class="Hui-iconfont">
        &#xe600;</i> 添加活动</a></span> <span class="r">共有数据：<strong><?php echo ($size); ?></strong> 条</span></div>
    <div class="mt-20">
