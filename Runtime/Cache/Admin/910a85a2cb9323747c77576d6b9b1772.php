    ...
    <form class="form form-horizontal" id="form-about-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" style="width:800px;height:600px;">
                ...
                <script type="text/javascript">
                    ...
                    $('#btn_submit').on('click', function () {
                        getLocalData();
                        var data = {};
                        var t = $('#form-about-add').serializeArray();
                        $.each(t, function() {
                        ...
                        $.post('/index.php/Admin/About/edit?id=7', data, function (ret) {
                            if (ret == 'true') {
