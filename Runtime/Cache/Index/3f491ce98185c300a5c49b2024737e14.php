...
<head>
    ...
    <link rel="stylesheet" href="<?php echo (INDEX_CSS_URL); ?>otherPartner.css">
</head>
...
<!--  main begin-->
<div class="other_main clear">
    <div class="left_nav fl">
        <a href="/index.php/Index/Other/contact">
            <p class="left_nav_p fl clear">
                <span class="fl">联系我们</span>
                <img  class="left_nav_jt fl" src="<?php echo (INDEX_IMAGES_URL); ?>other-jt-white.png" alt="">
            </p>
        </a>
        <a href="/index.php/Index/Other/partner">
            <p class="left_nav_p fl clear">
                <span class="fl" style="color:#ce1d19">合作伙伴</span>
                <img  class="left_nav_jt fl" src="<?php echo (INDEX_IMAGES_URL); ?>other-jt-red.png" alt="">
            </p>
        </a>

        <a href="/index.php/Index/Other/declaration">
            <p class="left_nav_p fl clear">
                <span class="fl">法律声明</span>
                <img  class="left_nav_jt fl" src="<?php echo (INDEX_IMAGES_URL); ?>other-jt-white.png" alt="">
            </p>
        </a>
    </div>
    ...
    <div class="right_main fl">
        <p class="right_main_tit">合作企业 </p>
        <div class="clear">
            <?php if(is_array($arrCooperation)): foreach($arrCooperation as $k=>$vo): if(in_array(($vo["category"]), explode(',',"1"))): ?><img src="<?php echo (UPLOAD_URL); echo ($vo["logo"]); ?>" alt="" style="width: 155px;height: 65px;"><?php endif; endforeach; endif; ?>

        </div>

        <p class="right_main_tit">金融机构</p>
        <div class="clear">
            <?php if(is_array($arrCooperation)): foreach($arrCooperation as $k=>$vo): if(in_array(($vo["category"]), explode(',',"2"))): ?><img src="<?php echo (UPLOAD_URL); echo ($vo["logo"]); ?>" alt="" style="width: 155px;height: 65px;"><?php endif; endforeach; endif; ?>

        </div>

        <p class="right_main_tit">合作高校</p>
        <div class="clear">
            <?php if(is_array($arrCooperation)): foreach($arrCooperation as $k=>$vo): if(in_array(($vo["category"]), explode(',',"3"))): ?><img src="<?php echo (UPLOAD_URL); echo ($vo["logo"]); ?>" alt="" style="width: 155px;height: 65px;"><?php endif; endforeach; endif; ?>
